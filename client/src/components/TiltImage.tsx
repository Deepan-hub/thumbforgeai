    ...
    return (
        ...
        >
            <motion.div className='relative transform-3d w-full max-w-4xl' style={{ rotateX, rotateY }}>
                <motion.img src='/hero_img.png' className='broderb bg-linear-180 from-orange-500 to-transparent p-1 w-full rounded-[15px] will-change-transform transform-[translateZ(0)]' alt='hero section showcase' />
            </motion.div>
        </motion.figure>
    );
}
